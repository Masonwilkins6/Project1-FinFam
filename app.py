...
class Question1Choices(db.Model, UserMixin):

    __tablename__ = 'Question 1 answer choices'

    id = db.Column(db.Integer, primary_key=True)

    question_num = db.Column(db.Integer, nullable=False)

    answer_choice_char = db.Column(db.String(1), nullable=False)
    
    answer_choice_string = db.Column(db.String(300), nullable=True)

    def __init__(self, question_num, user_id, current_adult, answer_choice_char, answer_choice_string):
        self.question_num = question_num
        self.user_id = user_id
        self.current_adult = current_adult
        self.answer_choice_letter = answer_choice_char
        self.answer_choice_string = answer_choice_string

    def __repr__(self):
        return "User id: {}, Answer Num: {}, Current Adult: {}, Answer letter: {}, answer string: {} ".format(self.user_id, self.answer_num, self.current_adult, self.answer_choice_char, self.answer_choice_string)

class Question2Choices(db.Model, UserMixin):

    __tablename__ = 'Question 2 answer choices'
...
class Question3Choices(db.Model, UserMixin):

    __tablename__ = 'Question 3 answer choices'
...
class Question4Choices(db.Model, UserMixin):

    __tablename__ = 'Question 4 answer choices'
...
class Question5Choices(db.Model, UserMixin):

    __tablename__ = 'Question 5 answer choices'
...
class Question6Choices(db.Model, UserMixin):

    __tablename__ = 'Question 6 answer choices'
